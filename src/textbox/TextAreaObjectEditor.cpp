...
const long TextAreaObjectEditor::ID_STATICTEXT3 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON5 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON2 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON7 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON6 = wxNewId();
const long TextAreaObjectEditor::ID_STATICTEXT5 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON8 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON9 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON10 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON11 = wxNewId();
const long TextAreaObjectEditor::ID_STATICTEXT8 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON12 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON13 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON14 = wxNewId();
const long TextAreaObjectEditor::ID_BUTTON15 = wxNewId();
const long TextAreaObjectEditor::ID_PANEL2 = wxNewId();
...
object(object_)
{
	...
	Connect(ID_BUTTON5,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnfocusedBackgroundBtClick);
	Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnhoveredBackgroundBtClick);
	Connect(ID_BUTTON7,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnnormalBackgroundBtClick);
	Connect(ID_BUTTON6,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OndisabledBackgroundBtClick);
	Connect(ID_BUTTON8,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnfocusedBorderBtClick);
	Connect(ID_BUTTON9,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnhoveredBorderBtClick);
	Connect(ID_BUTTON10,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnnormalBorderBtClick);
	Connect(ID_BUTTON11,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OndisabledBorderBtClick);
	Connect(ID_BUTTON12,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnfocusedTextBtClick);
	Connect(ID_BUTTON13,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnhoveredTextBtClick);
	Connect(ID_BUTTON14,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OnnormalTextBtClick);
	Connect(ID_BUTTON15,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&TextAreaObjectEditor::OndisabledTextBtClick);
...
void TextAreaObjectEditor::UseCorrectForeground(wxButton *bt)
{
...
void TextAreaObjectEditor::OnfocusedBackgroundBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnhoveredBackgroundBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnnormalBackgroundBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OndisabledBackgroundBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnfocusedBorderBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnhoveredBorderBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnnormalBorderBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OndisabledBorderBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnfocusedTextBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnhoveredTextBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OnnormalTextBtClick(wxCommandEvent& event)
{
...
void TextAreaObjectEditor::OndisabledTextBtClick(wxCommandEvent& event)
{
