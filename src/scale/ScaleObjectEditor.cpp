...
object(object_)
{
	...
	Create(parent, wxID_ANY, _("Editer la glissière"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxMAXIMIZE_BOX, _T("wxID_ANY"));
	FlexGridSizer1 = new wxFlexGridSizer(0, 1, 0, 0);
	FlexGridSizer1->AddGrowableCol(0);
	FlexGridSizer1->AddGrowableRow(1);
	FlexGridSizer8 = new wxFlexGridSizer(3, 1, 0, 0);
	StaticText6 = new wxStaticText(this, ID_STATICTEXT6, _("Glissière"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
	...
	StaticText7 = new wxStaticText(this, ID_STATICTEXT7, _("Permet de sélectionner un nombre dans un intervalle."), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
	...
	Notebook1 = new wxNotebook(this, ID_NOTEBOOK1, wxDefaultPosition, wxSize(398,195), 0, _T("ID_NOTEBOOK1"));
	...
	StaticText12 = new wxStaticText(Panel1, ID_STATICTEXT12, _("Il est préférable de rentrer\nune valeur possible suivant\nl\'écart des valeurs."), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT12"));
	...
	StaticText13 = new wxStaticText(Panel3, ID_STATICTEXT13, _("Epaisseur de la glissière :"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT13"));
    ...
    colorsPanel->AddColorScheme("trough", _("Glissière"), object.GetTroughColorScheme(), CSP_HasUnfocusedColorBt|CSP_HasDisabledColorBt);
...
void ScaleObjectEditor::OnokBtClick(wxCommandEvent& event)
{
    ...
    {
        wxMessageBox("Les valeurs sont mal renseignées.\nIl se peut que la valeur dépasse le maximum ou le minimum...", "Erreur");
        return;
    }
