...
WizardSelectDir=Dossier où est installé Game Develop
SelectDirDesc=Où est installé Game Develop ?
...
DirExistsTitle=Valider ?
DirExists=Le dossier :%n%n%1%n%ncontient-il Game Develop (GDEditor.exe) ?
