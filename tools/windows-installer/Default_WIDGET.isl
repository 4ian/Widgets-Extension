...
WizardSelectDir=Select Game Develop path
SelectDirDesc=Where is Game Develop ?
...
DirExistsTitle=Validation
DirExists=The folder:%n%n%1%n%ncontain Game Develop ?
