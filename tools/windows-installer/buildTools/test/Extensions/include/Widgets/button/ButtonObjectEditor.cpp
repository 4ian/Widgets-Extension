...
const long ButtonObjectEditor::ID_STATICLINE1 = wxNewId();
...
object(object_)
{
	...
	StaticText6 = new wxStaticText(this, ID_STATICTEXT6, _("Bouton"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
	...
	StaticText7 = new wxStaticText(this, ID_STATICTEXT7, _("Permet de capter le clic de l\'utilisateur sur ce dernier."), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
